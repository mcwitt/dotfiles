  ...
  (setq-default
   ...
   '(helm
     ...
     (mu4e :variables
           ...
           mu4e-maildir-shortcuts `((,mu4e-sent-folder . ?s)
                                    (,mu4e-trash-folder . ?t))
           ...
           user-full-name  "Matthew Wittmann"
...
(defun mcw/config-org-mode ()

  (setq mcw/org-gtd-file "~/org/gtd.org")

  (eval-after-load 'org
    (lambda ()
      (setq org-agenda-files (list mcw/org-gtd-file))
...
(defun mcw/config-database ()
  "Database connections. See
https://truongtx.me/2014/08/23/setup-emacs-as-an-sql-database-client"

  (when (file-exists-p "~/.sql-connections.el")
