  ...
  (eval-after-load 'org
    (lambda ()
      ...
      (setq
       ...
       '(("t" "Task" entry (file+headline (mcw/org-prefix-file "gtd.org") "Tasks")
          "* TODO %?\nDEADLINE: %t\n%i")
         ("T" "Task w/ attachment" entry (file+headline (mcw/org-prefix-file "gtd.org") "Tasks")
          "* TODO %?\nDEADLINE: %t\n%i\n%a")
         ("r" "Reading" entry (file+headline (mcw/org-prefix-file "gtd.org") "Reading")
          "* TODO %?\n%i")
         ("n" "Note" entry (file+datetree (mcw/org-prefix-file "notes.org"))
          "* %?\n%i")
         ("N" "Note w/ attachment" entry (file+datetree (mcw/org-prefix-file "notes.org"))
          "* %?\n%i\n%a")
